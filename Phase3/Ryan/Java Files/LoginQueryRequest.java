...
public class LoginQueryRequest extends StringRequest {
    ...
    public LoginQueryRequest(String email, String password, String url, Response.Listener<String> listener){
